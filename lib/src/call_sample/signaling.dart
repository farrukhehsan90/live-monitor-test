...
class Signaling {
  ...
  Map<String, dynamic> _iceServers = {
    'iceServers': [
      ...
      {
        'url': 'turn:webrtc.ml360-testing.dev:3478',
        'username': 'sammrafi',
        'credential': 'sammrafi'
      },
      {
        'url': 'stun:webrtc.ml360-testing.dev:3478',
        'username': 'sammrafi',
        'credential': 'sammrafi'
      },
    ]
  ...
  void onMessage(message) async {
    ...
    switch (mapData['type']) {
      case 'peers': //Change in list of peers
        {
  ...
  Future<void> connect(String session_id, String juce_client_type) async {
    ...
    if (_turnCredential == null) {
      try {
        ...
        */
        debugPrint("Turn Server: $_turnCredential");
        // _iceServers = {
        //   'iceServers': [
        //     {
        ...
        debugPrint("The error: ice Server: $e");
      }
    }

    //Notify the server about this new connection. Pass the session id
    _socket?.onOpen = () {
      print('onOpen');
      ...
      _send('new', {
        ...
        'juce_session_id': session_id,
        'juce_client_type': juce_client_type
      });
    };
  ...
  Future<MediaStream> createStream(String media, bool userScreen,
    ...
    onLocalStream?.call(stream);
    if (_localStream != null) {
      audioInput = _localStream?.getAudioTracks()[0];
    }
    return stream;
  }
  ...
  Future<Session> _createSession(
    ...
    debugPrint("Ice Server: $_iceServers");
